 ...
 */
public class MixedThreadPoolTest {
	
	public static void main(String[] a){
		MixedThreadPoolTest threadPoolTest=new MixedThreadPoolTest();
		threadPoolTest.test();
	}
	
	public void test(){
		URL url=new URL("","",0);
		ThreadPoolExecutor e = (ThreadPoolExecutor) new MixedThreadPool().getExecutor(url);
